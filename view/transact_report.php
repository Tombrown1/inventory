...
?>
    <div class="container-fluid">       
        ...
        <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title" style="text-align:center;"><strong>Generate Transaction Report</strong></h4>
                    ...
                    <?php
                                $cnt = 1;
                                $result = get_transaction_report($mysqli);
                    ...
                    <div class="container">
                        <a href="export_trans_report.php" class="btn btn-success"> Export to PDF</a>
                    </div>
</div>
        </div>
    </div>
